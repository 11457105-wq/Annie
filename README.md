...
<body>
    ...
    <div class="welcome-box text-card">
        ...
        <div class="origin-photo">
            <img src="https://scontent.fkhh1-1.fna.fbcdn.net/v/t39.30808-6/505988188_10016236228413046_7521403908418223622_n.jpg?stp=dst-jpg_tt6&cstp=mx720x480&ctp=s720x480&_nc_cat=102&ccb=1-7&_nc_sid=cf85f3&_nc_ohc=w9Wj5aGC5_UQ7kNvwFICLYN&_nc_oc=AdqArFQN_uwuKls3FYBwJNRKnDFMZGhn4fDFzaWNSuhtb2XTnUKrS3urt5x9S_LG2iI&_nc_zt=23&_nc_ht=scontent.fkhh1-1.fna&_nc_gid=mJ3_I4zV6LnmZKfp6wOZKQ&_nc_ss=7b289&oh=00_Af_0qje_184nxBEUwG7J9AEUoZ7EzQaHhkqm3TDBPDebLQ&oe=6A2BEF14" class="origin-img" alt="龍潭大池起源">
...
<section id="now-func" class="page-section">
    <div class="welcome-box text-card">
        ...
        <div class="content-block">
            <h3>二、現代三大功能解構</h3>
            <p class="article-p">
                <strong>• 觀光休閒：</strong>興建完善的環湖步道與水岸景觀，成為兼具美學與遊憩價值的都會親水空間。<br>
                <div class="origin-photo">
<img src="
                龍潭大池農業關係（資料來源：HouseWsb）
            </div>
                <strong>• 城市滯洪：</strong>在面對極端氣候與豪大雨時，大池承擔起調節周邊區域水量的滯洪重任，保障周邊居民的安全。<br>
                <strong>• 水質淨化科技：</strong>導入先進的「多層複合濾料（MSL）系統」與「礫間水質淨化設施」，利用純自然、低碳的生物濾料與微生物分解，在不添加化學藥劑的情況下有效淨化流入大池的水質，打造永續的綠色水環境。
            </p>
        </div>
    </div>
</section>
